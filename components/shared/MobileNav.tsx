                                ...
                                <ul className="header-nav_elements">
                                    {
                                        navLinks.map((link) => {
                                            ...
                                            return (
                                                <li key={link.route} className={`${isActive && 'gradient-text'} cursor-pointer p-18 flex whitespace-nowrap text-dar `} >
                                                    <Link href={link.route} className='sidebar-link'  >
                                                        <Image src={link.icon} alt={`${link.label} Logo`} width={24} height={24} />
                                                        {link.label}
                                                    </Link>
                                                </li>
                                            )
